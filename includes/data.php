...
$portfolio = [
  ...
  'projects' => [
    [
      ...
      'desc'     => 'End-to-end pipeline for fine-tuning large language models using LoRA/QLoRA. Includes data preprocessing, training, evaluation, and one-click deployment.',
      'tags'     => ['Python', 'PyTorch', 'HuggingFace', 'LoRA'],
      'category' => 'AI / ML',
      'color'    => '#00ffc8',
      'demo'     => '#',
      'code'     => '#',
